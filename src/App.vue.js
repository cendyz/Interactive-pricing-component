...
function __VLS_template() {
    ...
    __VLS_elementAsFunction(__VLS_intrinsicElements.main, __VLS_intrinsicElements.main)(__assign({ class: ("flex flex-col py-[7em] px-[1em] container") }));
    ...
    __VLS_elementAsFunction(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)(__assign({ class: ("flex flex-col items-center mt-[5em] p-[1.7em] bg-white rounded-xl rounded-b-none border-b border-b-gray-slate-100 md:w-[450px] md:mx-auto md:p-[2.5em]") }));
    ...
    __VLS_elementAsFunction(__VLS_intrinsicElements.span, __VLS_intrinsicElements.span)(__assign({ class: ("absolute top-[15.6%] left-[8%] w-[17px] h-[17px] bg-white rounded-full btnToggle") }, { style: (({ left: __VLS_ctx.data.toggle ? '56%' : '8%' })) }));
    ...
    __VLS_elementAsFunction(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)(__assign({ class: ("flex flex-col bg-white p-[1.7em] items-center gap-y-[.3em] md:w-[450px] md:mx-auto md:p-[2.5em] md:flex-row md: justify-between md:items-center") }));
    ...
    ['', 'flex', 'flex-col', 'py-[7em]', 'px-[1em]', 'container', 'relative', 'flex', 'flex-col', 'gap-y-[.6em]', 'text-center', 'font-manrope800', 'relative', 'z-10', 'text-[1.2rem]', 'relative', 'z-10', 'text-[.8rem]', 'px-[6em]', 'text-grayishBlue', 'font-manrope600', 'absolute', 'left-1/2', 'top-1/2', '-translate-x-[50%]', '-translate-y-[50%]', 'flex', 'flex-col', 'items-center', 'mt-[5em]', 'p-[1.7em]', 'bg-white', 'rounded-xl', 'rounded-b-none', 'border-b', 'border-b-gray-slate-100', 'md:w-[450px]', 'md:mx-auto', 'md:p-[2.5em]', 'flex', 'justify-center', 'md:justify-between', 'items-center', 'w-full', 'uppercase', 'text-grayishBlue', 'font-manrope600', 'text-[.8rem]', 'gap-x-[.5em]', 'items-center', 'hidden', 'md:flex', 'text-[2rem]', 'font-manrope800', 'text-grayishBlue', 'input', 'my-[1.7em]', 'appearance-none', 'w-full', 'bg-transparent', 'cursor-pointer', 'flex', 'gap-x-[.5em]', 'items-center', 'md:hidden', 'text-[2rem]', 'font-manrope800', 'text-grayishBlue', 'flex', 'items-center', 'mt-[1.7em]', 'capitalize', 'text-[.8rem]', 'text-grayishBlue', 'font-manrope600', 'py-[.8em]', 'px-[1.5em]', 'bg-lightGrayishBlue-toggleBackground', 'rounded-3xl', 'mx-[.7em]', 'relative', 'transition-colors', 'duration-200', 'hover:bg-softCyan', 'absolute', 'top-[15.6%]', 'left-[8%]', 'w-[17px]', 'h-[17px]', 'bg-white', 'rounded-full', 'btnToggle', 'text-[.8rem]', 'text-grayishBlue', 'relative', 'after:content-[\'-25%\']', 'after:absolute', 'after:top-1/2', 'after:translate-y-[-50%]', 'after:right-[-55%]', 'after:text-lightRed', 'after:bg-lightGrayishRed', 'after:text-[.6rem]', 'font-manrope600', 'after:px-[.7em]', 'after:py-[.2em]', 'after:rounded-2xl', 'md:after:right-[-110%]', 'discount', 'flex', 'flex-col', 'bg-white', 'p-[1.7em]', 'items-center', 'gap-y-[.3em]', 'md:w-[450px]', 'md:mx-auto', 'md:p-[2.5em]', 'md:flex-row', 'md:', 'justify-between', 'md:items-center', 'flex', 'items-center', 'gap-x-[1.1em]', 'text-grayishBlue', 'text-[.8rem]', 'font-manrope600', 'py-[.8em]', 'px-[3.5em]', 'mt-[2em]', 'rounded-3xl', 'bg-darkDesaturatedBlue', 'text-paleBlue', 'font-manrope600', 'text-[.8rem]', 'md:mt-0', 'transition-colors', 'hover:text-white',];
    var __VLS_slots;
    var $slots;
